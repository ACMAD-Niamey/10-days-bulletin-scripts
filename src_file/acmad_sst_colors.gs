...
*'set rgb 100 0   64  191 255'
*'set rgb 100 0   64  191 255'
 'set rgb 101 38  26  255 255'
 'set rgb 102 0   204 255 255'
 'set rgb 103 0   255 255 255'
 'set rgb 104 255 255 255 255'
*'set rgb 100 255 255 255 255'
 'set rgb 105 255 255 153 255'
 'set rgb 106 255 204 0   255'
 'set rgb 107 255 0   0   255'
 'set rgb 108 153 0   0   255'
*'set rgb 100 153 0   0   255'
*'set rgb 100 153 0   0   255'
*'set rgb 100 153 0   0   255'
*'set rgb 100 153 0   0   255'
*'set rgb 100 153 0   0   255'
...
*-5.5 ,0  ,64 ,191,255,<= -5.5
*-5   ,0  ,64 ,191,255,-5.5 - -5
*-4.5 ,0  ,64 ,191,255,-5 - -4.5
*-4   ,0  ,64 ,191,255,-4.5 - -4
*-3.5 ,0  ,64 ,191,255,-4 - -3.5
*-3   ,0  ,64 ,191,255,-3.5 - -3
*-2.5 ,0  ,64 ,191,255,-3 - -2.5
*-2   ,0  ,64 ,191,255,-2.5 - -2
*-1.5 ,38 ,26 ,255,255,-2 - -1.5
*-1   ,0  ,204,255,255,-1.5 - -1
*-0.5 ,0  ,255,255,255,-1 - -0.5
*0    ,255,255,255,255,-0.5 - 0
*0.5  ,255,255,255,255,0 - 0.5
*1    ,255,255,153,255,0.5 - 1
*1.5  ,255,204,0  ,255,1 - 1.5
*2    ,255,0  ,0  ,255,1.5 - 2
*2.5  ,153,0  ,0  ,255,2 - 2.5
*3    ,153,0  ,0  ,255,2.5 - 3
*3.5  ,153,0  ,0  ,255,3 - 3.5
*4    ,153,0  ,0  ,255,3.5 - 4
*4.5  ,153,0  ,0  ,255,4 - 4.5
*5    ,153,0  ,0  ,255,4.5 - 5
*5.5  ,153,0  ,0  ,255,5 - 5.5
*inf  ,153,0  ,0  ,255,> 5.5
