...
'set time date1'
*
'define pcl = tpr*ave(rain.1/10, time=date1,time=date2)'
'define pclim = lterp(pcl,mask.2(t=1))'
*'define pclim = tpr*ave(rain.1/10, time=date1,time=date2)'
...
*'set time date1 date1'
*'set sdfwrite -zip Africa_rev_rfe_normal_precip.nc'
*'sdfwrite pclim0'

*'save -v pclim0 -f netCDF -c 0 -d "yes" -u -999.0 -o Africa_rev_rfe_normal_precip'
